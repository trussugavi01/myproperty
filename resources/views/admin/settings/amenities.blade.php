                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-{{ $amenity->is_active ? 'success' : 'secondary' }}">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning" 
                                                    ...
                                                    data-bs-target="#editModal{{ $amenity->id }}">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <form action="{{ route('admin.settings.amenities.delete', $amenity) }}" 
                                    ...
                                    <div class="modal fade" id="editModal{{ $amenity->id }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.settings.amenities.update', $amenity) }}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.settings.amenities.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Name *</label>
